...
namespace Pharmacy.API.Controllers
{
    ...
    public class MedicineController : BaseController
    {
        ...
        public MedicineController(IMedicineService _medicineService, IMapper _mapper, IMemoryCache _memoryCache) : base(_memoryCache)
        {
        ...
        //İlac silme
        [HttpDelete("{id}")]
        public General<DeleteMedicineViewModel> Delete([FromBody] DeleteMedicineViewModel medicine , int id)
        {
            return medicineService.Delete(medicine , id);
        }
